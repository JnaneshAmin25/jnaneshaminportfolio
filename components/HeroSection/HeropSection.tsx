...
export default function HeroSection() {
  ...
  return (
		<section id="home" className="hero-section relative min-h-screen flex items-center justify-center bg-gradient-to-br from-blue-50 to-purple-50 dark:from-black dark:to-gray-800 ">          
			...
			<div className="hero-content container mx-10 md:mx-auto px-6 py-13 md:py-10 flex flex-col md:flex-row items-center ">
				<div className="order-2 p-0 xl:pl-20 md:order-1 md:w-1/2 mb-10 md:mb-0 mt-10 md:mt-0" data-aos="fade-right">
					<h1 className="hero-title text-3xl md:text-5xl font-bold text-gray-800 dark:text-white mb-4 text-center md:text-left">
						Hi, I&apos;m {" "} 
						<span className="ml-3 md:ml-0 inline-block">
							<MyName name="Jnanesh Amin" />
						</span>
					</h1>
					<h2 className="hero-subtitle text-2xl md:text-3xl text-gray-600 dark:text-gray-300 mb-6 text-center md:text-left">
						Full Stack Developer & UI Enthusiast
					</h2>
					<p className="hero-description text-gray-600 dark:text-gray-300 mb-8 max-w-lg text-center md:text-left">
					...
					<div className="flex flex-col space-y-6">
						<div className="flex space-x-4 justify-center md:justify-start">
							...
							<a href="https://github.com/JnaneshAmin25" target="_blank" rel="noopener noreferrer" className="social-icon group" aria-label="GitHub">
								<div className="w-10 h-10 md:w-15 md:h-15 flex items-center justify-center rounded-full border border-gray-300 dark:border-gray-600 bg-transparent hover:bg-gray-100 dark:hover:bg-gray-800 transition-colors duration-300 relative overflow-hidden">
									<FaGithub className="text-gray-700 dark:text-gray-300 group-hover:text-blue-600 dark:group-hover:text-blue-400 transition-colors duration-300" size={34}  />
									<span className="absolute inset-0 bg-gradient-to-br from-transparent via-transparent to-gray-200 dark:to-gray-700 opacity-0 group-hover:opacity-100 transition-opacity duration-300"></span>
								</div>
							</a>
							{/* LinkedIn */}
							<a href="https://www.linkedin.com/in/jnanesh-amin-b84ab5313/" target="_blank" rel="noopener noreferrer" className="social-icon group" aria-label="LinkedIn">
								<div className="w-10 h-10 md:w-15 md:h-15 flex items-center justify-center rounded-full border border-gray-300 dark:border-gray-600 bg-transparent hover:bg-gray-100 dark:hover:bg-gray-800 transition-colors duration-300 relative overflow-hidden">
									<FaLinkedin className="text-gray-700 dark:text-gray-300 group-hover:text-blue-600 dark:group-hover:text-blue-400 transition-colors duration-300" size={34}  />
									<span className="absolute inset-0 bg-gradient-to-br from-transparent via-transparent to-gray-200 dark:to-gray-700 opacity-0 group-hover:opacity-100 transition-opacity duration-300"></span>
								</div>
							</a>
							{/* Twitter/X */}
							<a href="https://twitter.com/yourusername" target="_blank" rel="noopener noreferrer" className="social-icon group" aria-label="Twitter">
								<div className="w-10 h-10 md:w-15 md:h-15 flex items-center justify-center rounded-full border border-gray-300 dark:border-gray-600 bg-transparent hover:bg-gray-100 dark:hover:bg-gray-800 transition-colors duration-300 relative overflow-hidden">
									<FaTwitter className="text-gray-700 dark:text-gray-300 group-hover:text-blue-600 dark:group-hover:text-blue-400 transition-colors duration-300" size={34}  />
									<span className="absolute inset-0 bg-gradient-to-br from-transparent via-transparent to-gray-200 dark:to-gray-700 opacity-0 group-hover:opacity-100 transition-opacity duration-300"></span>
								</div>
							</a>
						</div>
				...
				<div className="order-1 md:order-2 md:w-1/2 flex justify-center" data-aos="fade-left">
					<div className=" relative w-80 h-80 md:w-[23rem] md:h-[23rem] lg:w-[32rem] lg:h-[32rem]  rounded-full shadow-xl p-[5px] overflow-hidden border-4 border-white dark:border-gray-800">
