							...
							<div className="space-y-4">
								...
								<div className="flex items-start">
									...
									<div>
										...
										<a href="tel:8123834047" className="text-blue-400 hover:underline">+91 8123834047</a>
									</div>
								</div>
							...
							<form ref={formRef} onSubmit={sendEmail} className="space-y-6">
								...
								<div className="grid grid-cols-1 md:grid-cols-2 gap-6">
									...
									<div>
										...
										<input type="text" name="user_name" id="name" required className="w-full px-4 py-2 border border-gray-600 rounded-lg focus:ring-blue-500 focus:border-blue-500 bg-gray-700 text-white" />
									</div>
									{/* Email Input */}
									<div>
										...
										<input type="email" name="user_email" id="email" required className="w-full px-4 py-2 border border-gray-600 rounded-lg focus:ring-blue-500 focus:border-blue-500 bg-gray-700 text-white"/>
									</div>
								</div>
								...
								<div>
									...
									<input type="text" name="subject" id="subject" required className="w-full px-4 py-2 border border-gray-600 rounded-lg focus:ring-blue-500 focus:border-blue-500 bg-gray-700 text-white"/>
								</div>
								{/* Email Message */}
								<div>
									...
									<textarea name="message" id="message" rows={5} required className="w-full px-4 py-2 border border-gray-600 rounded-lg focus:ring-blue-500 focus:border-blue-500 bg-gray-700 text-white"></textarea>
								</div>
